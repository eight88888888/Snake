...
int timeSince = 0, timeLast = 0;//timeLast is the value of millis() at last run, while timeSince is  timeLast - millis()
...
void draw(){
  ...
  timeSince = millis() - lastTime;
  if(timeSince < 250){//A certain amount of time has past
